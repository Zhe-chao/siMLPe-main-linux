...
# Ensure the shared lib directory is resolved before importing project modules.
...
def _adapt_state_dict_keys(state_dict):
    """Allow loading checkpoints saved with legacy module names."""
...
if __name__ == "__main__":
    ...
    state_dict = torch.load(args.model_pth, map_location=DEVICE)
